...
export default function KeyboardStudioModal({
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-3 sm:p-6 bg-black/85 backdrop-blur-md animate-in fade-in duration-200">
      ...
      >
        {/* CABEÇALHO */}
        <div className="flex items-center justify-between p-5 sm:px-8 border-b border-white/10 bg-gradient-to-r from-cyan-950/40 via-[#161616] to-[#111111] shrink-0">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-2xl bg-gradient-to-br from-cyan-500 to-blue-600 flex items-center justify-center text-xl shadow-lg shadow-cyan-500/20 shrink-0">
              🎹
            </div>
            <div>
        ...
        <div className="flex-1 min-h-0 overflow-y-auto p-5 sm:p-8 custom-scrollbar space-y-6">
          {activeTab === 'PRESETS' ? (
            ...
            <div className="space-y-6">
              ...
              <div className="flex flex-wrap gap-2 border-b border-white/5 pb-3 shrink-0">
                {[
